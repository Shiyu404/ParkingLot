    ...
    const handleFindByCitation = async () => {
        ...
        try {
            ...
            if (err instanceof SyntaxError) {
                console.error('SyntaxError: Response is not in JSON format. It might be HTML instead.');
                toast({
                    title: "Error",
                    description: "Failed to search for the ticket. Please try again.",
                    variant: "destructive",
    ...
    const handleFindByPlate = async () => {
        ...
        try {
            ...
            try {
                ...
                response = await fetch(API_ENDPOINTS.getViolationByPlate(licensePlate, regionCode));
                ...
                console.log('First API attempt failed, trying direct URL...');
                //If failed, try URL without /api prefix
                response = await fetch(`/search?plate=${encodeURIComponent(licensePlate)}&province=${encodeURIComponent(regionCode)}`);
