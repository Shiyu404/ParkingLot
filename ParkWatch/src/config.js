...
export const API_ENDPOINTS = {
    ...
    createViolation: '/api/violations/creation',
    getViolationById: (ticketId) => `/api/violations/${ticketId}`,
    getViolationByPlate: (plate, province) => 
        `/api/search?plate=${encodeURIComponent(plate)}&province=${encodeURIComponent(province)}`,
